function requirePriceId(envVar: string): string {
  ...
  if (!value) {
    throw new Error(
      `Missing required env var ${envVar}. Set it in .env.local for local dev and in apphosting.yaml for production.`
    );
  }
  return value;
}
...
export const PRICE_TIERS = [
  {
    ...
    employeeCap: 15,
    priceId: requirePriceId("NEXT_PUBLIC_STRIPE_PRICE_TIER1"),
    priceLabel: "$29/mo",
  },
  {
    key: "tier2",
    ...
    employeeCap: 25,
    priceId: requirePriceId("NEXT_PUBLIC_STRIPE_PRICE_TIER2"),
    priceLabel: "$49/mo",
  },
  {
    key: "tier3",
    ...
    employeeCap: 50,
    priceId: requirePriceId("NEXT_PUBLIC_STRIPE_PRICE_TIER3"),
    priceLabel: "$79/mo",
  },
  {
    key: "tier4",
    ...
    employeeCap: 75,
    priceId: requirePriceId("NEXT_PUBLIC_STRIPE_PRICE_TIER4"),
    priceLabel: "$99/mo",
  },
  {
    key: "tier5",
    ...
    employeeCap: 100,
    priceId: requirePriceId("NEXT_PUBLIC_STRIPE_PRICE_TIER5"),
    priceLabel: "$129/mo",
  },
] as const;
